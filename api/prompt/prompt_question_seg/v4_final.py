...
"For each element, explicitly state: 'This is [question text/instruction/mathematical expression] and should be [included/excluded] because [specific reason].'\n\n"
...
"Before outputting, confirm: 'I have included all question content, excluded all instructions, and formatted [X] mathematical expressions correctly. Specifically, I have verified that:\n"
